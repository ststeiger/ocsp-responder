...
namespace OcspResponder.Core.Internal
{
    ...
    internal interface IBcOcspResponderRepository
    {
        ...
        System.Threading.Tasks.Task<bool> SerialExists(BigInteger serial, X509Certificate issuerCertificate);
        ...
        System.Threading.Tasks.Task<CertificateRevocationStatus> SerialIsRevoked(BigInteger serial, X509Certificate issuerCertificate);
        ...
        System.Threading.Tasks.Task<CaCompromisedStatus> IsCaCompromised(X509Certificate caCertificate);
        ...
        System.Threading.Tasks.Task<AsymmetricKeyParameter> GetResponderPrivateKey(X509Certificate caCertificate);
        ...
        System.Threading.Tasks.Task<AsymmetricKeyParameter> GetResponderPublicKey(X509Certificate caCertificate);
        ...
        System.Threading.Tasks.Task<X509Certificate[]> GetChain(X509Certificate issuerCertificate);
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<X509Certificate>> GetIssuerCertificates();
